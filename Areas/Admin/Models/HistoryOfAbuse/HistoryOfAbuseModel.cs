namespace LittleArkFoundation.Areas.Admin.Models.HistoryOfAbuse
{
    public class HistoryOfAbuseModel
    {
        ...
        public decimal SexualAbuseAgeOfChild { get; set; } = 0;
        ...
        public decimal PhysicalAbuseAgeOfChild { get; set; } = 0;
        ...
        public decimal EmotionalAbuseAgeOfChild { get; set; } = 0;
        ...
        public decimal VerbalAbuseAgeOfChild { get; set; } = 0;
        ...
        public decimal AbandonedAbuseAgeOfChild { get; set; } = 0;
        ...
        public decimal PsychologicalAbuseAgeOfChild { get; set; } = 0;
