...
namespace LittleArkFoundation.Data
{
    public class HtmlTemplateService
    {
        ...
        public async Task<string> ModifyHtmlTemplateAsync_Page1(string htmlContent, int id, int assessmentID)
        {
            ...
            if (patientage != null)
            {
                patientage.InnerHtml = assessment.Age;
            }
            ...
            foreach (var familyMember in familymembers)
            {
                ...
                if (age != null)
                {
                    age.InnerHtml = familyMember.Age;
                }
        ...
        public async Task<string> ModifyHtmlTemplateAsync_Page3(string htmlContent, int id, int assessmentID)
        {
            ...
            if (medicalscreenings.HasScreeningDone)
            {
                ...
                if (hearingdate != null && medicalscreenings.HearingTestDate != DateOnly.MinValue)
                {
                ...
                if (visiondate != null && medicalscreenings.VisionTestDate != DateOnly.MinValue)
                {
                ...
                if (speechdate != null && medicalscreenings.SpeechTestDate != DateOnly.MinValue)
                {
        ...
        public async Task<string> ModifyHtmlTemplateAsync_Page4(string htmlContent, int id, int assessmentID)
        {
            ...
            if (pregnancybirthhistory.WasChildAdopted)
            {
                ...
                if (adoptedage != null)
                {
                    adoptedage.InnerHtml = pregnancybirthhistory.ChildAdoptedAge;
                }
        ...
        public async Task<string> ModifyHtmlTemplateAsync_Page6(string htmlContent, int id, int assessmentID)
        {
            ...
            if (fostercare.HasBeenFosterCared == "Yes")
            {
                ...
                {
                    fosteragestart.InnerHtml = fostercare.FosterAgeStart;
                }

                var fosterageend = htmlDoc.DocumentNode.SelectSingleNode("//div[@class='Toage']");
                if (fosterageend != null)
                {
                    fosterageend.InnerHtml = fostercare.FosterAgeEnd;
                }
        ...
        public async Task<string> ModifyHtmlTemplateAsync_Page7(string htmlContent, int id, int assessmentID)
        {
            ...
            if (historyofabuse.SexualAbuse)
            {
                ...
                if (atwhatage != null)
                {
                    atwhatage.InnerHtml = historyofabuse.SexualAbuseAgeOfChild;
                }
            ...
            if (historyofabuse.PhysicalAbuse)
            {
                ...
                if (atwhatage != null)
                {
                    atwhatage.InnerHtml = historyofabuse.PhysicalAbuseAgeOfChild;
                }
            ...
            if (historyofabuse.EmotionalAbuse)
            {
                ...
                if (atwhatage != null)
                {
                    atwhatage.InnerHtml = historyofabuse.EmotionalAbuseAgeOfChild;
                }
            ...
            if (historyofabuse.VerbalAbuse)
            {
                ...
                if (atwhatage != null)
                {
                    atwhatage.InnerHtml = historyofabuse.VerbalAbuseAgeOfChild;
                }
            ...
            if (historyofabuse.AbandonedAbuse)
            {
                ...
                if (atwhatage != null)
                {
                    atwhatage.InnerHtml = historyofabuse.AbandonedAbuseAgeOfChild;
                }
            ...
            if (historyofabuse.PsychologicalAbuse)
            {
                ...
                if (atwhatage != null)
                {
                    atwhatage.InnerHtml = historyofabuse.PsychologicalAbuseAgeOfChild;
                }
            ...
            if (historyofviolence.SexualAbuse)
            {
                ...
                if (atwhatage != null)
                {
                    atwhatage.InnerHtml = historyofviolence.SexualAbuseAgeOfChild;
                }
            ...
            if (historyofviolence.PhysicalAbuse)
            {
                ...
                if (atwhatage != null)
                {
                    atwhatage.InnerHtml = historyofviolence.PhysicalAbuseAgeOfChild;
                }
            ...
            if (historyofviolence.EmotionalAbuse)
            {
                ...
                if (atwhatage != null)
                {
                    atwhatage.InnerHtml = historyofviolence.EmotionalAbuseAgeOfChild;
                }
            ...
            if (historyofviolence.VerbalAbuse)
            {
                ...
                if (atwhatage != null)
                {
                    atwhatage.InnerHtml = historyofviolence.VerbalAbuseAgeOfChild;
                }
            ...
            if (historyofviolence.AbandonedAbuse)
            {
                ...
                if (atwhatage != null)
                {
                    atwhatage.InnerHtml = historyofviolence.AbandonedAbuseAgeOfChild;
                }
